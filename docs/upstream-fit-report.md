...
Status: automated real-host, loader-preflight, packaging, and live-output TUI checks passed; remaining interactive checks pending
...
| OpenCode automated loader observation | 1.18.19 passed on 2026-08-21 |
| opencode-ssh | 0.1.0 |
...
| --- | --- | --- | --- |
| Build and package install | Pass | Verified source installer, successful build, 146 default-suite tests, isolated package install, and installed package export import | No |
...
| Live Bash automated coverage | Pass | The current real-SSH-free default suite passed 22 files and 146 tests | No |
...
ordering, not TUI rendering on that version.
